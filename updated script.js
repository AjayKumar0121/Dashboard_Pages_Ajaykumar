  ...
  const wsClient = {
        ...
        try {
          ...
          if (data.type === 'employeeDetails') {
            ...
            try {
              ...
              console.log('Saved to localStorage:', data.details); // Debug log
    ...
    sendEmployeeDetails: (details) => {
      if (state.ws && state.ws.readyState === WebSocket.OPEN) {
        ...
        console.log('Sent WebSocket message:', message); // Debug log
      } else {
        console.warn('WebSocket not open, cannot send employee details');
      }
    },
      ...
      try {
        ...
        if (state.personnelDetails) {
          try {
            ...
            console.log('verifySession saved to localStorage:', state.personnelDetails); // Debug log
          ...
          console.warn('No personnel data returned from /api/profile'); // Debug log
          // Do not remove localStorage here to prevent wiping valid data
        }
        ...
        if (response.ok) {
          ...
          if (data.personnel) {
            try {
              ...
              console.log('Login saved to localStorage:', data.personnel); // Debug log
